...
const TRANSLATIONS = {
  'pt': {
    ...
    // ── Seção Efeitos de Tela (landing) ─────────────────────────────────────
    fx_section_label:   'EFEITOS DE TELA',
    fx_section_title:   '36 Efeitos Cinematográficos',
    fx_section_sub:     'Do Glitch ao Aurora, do Duotone ao Matrix — aplique com um clique diretamente no vídeo.',
    fx_section_cta:     '✨ Todos disponíveis no editor Pro — sem instalação, roda no navegador',

    sfx_count:            '68 sons',
    // ── Frames panel ──────────────────────────────────────────────────────────
    frames_btn:           '🖼 Molduras',
    frames_title:         '🖼 Molduras',
    frames_active_one:    'ativa',
    frames_active_many:   'ativas',
    frames_label:         '🖼 Moldura',
    frames_remove:        '✕ Remover',
    frames_remove_all:    '✕ Remover todas as molduras',
    frames_color:         'Cor',
    frames_color2:        'Cor 2',
    frames_thickness:     'Espessura',
    frames_opacity:       'Opacidade',
    frames_rotation:      'Rotação',
    frames_corners:       'Cantos',
    frames_size:          'Tamanho:',
    frames_fullscreen:    'Tela cheia',
    frames_square:        'Quadrado',
    // ── Zoom Animado / Keyframes ──────────────────────────────────────────────
    kf_zoom_title:        '🎬 Zoom Animado',
    kf_scale:             'Escala',
    kf_opacity:           'Opacidade',
    kf_anchor:            'Âncora',
    kf_clear:             'Limpar',
    kf_hint_main:         'Pausa o play, ajuste o tempo e clique + KF para capturar.',
    kf_preset_kenburns:   'Ken Burns',
    kf_preset_punchin:    'Punch In',
    kf_preset_zoomout:    'Zoom Out',
    kf_preset_pulse:      'Pulse',
    kf_preset_fadein:     'Fade In',
    // ── FX Panel ──────────────────────────────────────────────────────────────
    fx_title:             '🎬 Efeitos',
    fx_active:            'Ativo',
    fx_remove:            '✕ Remover',
    // ── Cor & Curvas ──────────────────────────────────────────────────────────
    cc_btn:               'Cor & Curvas',
    cc_title:             '🎨 Cor Cinematográfica',
    cc_chroma_global:     '🌈 Aberração Cromática Global',
    cc_curves:            '📊 Curvas de Cor',
    cc_reset:             '↺ Reset curvas',
    // ── Máscara e Aberração por elemento ──────────────────────────────────────
    el_mask:              '✂️ Máscara',
    el_mask_feather:      'Suavidade',
    el_chroma:            '🌈 Aberração Cromática',
    el_chroma_int:        'Intensidade',
    // ── BG Panel tabs ─────────────────────────────────────────────────────────
    bg_tab_gradients:     '🎨 Gradientes',
    bg_tab_photos:        '🔍 Fotos',
    bg_tab_generate:      '⚡ Gerar',
    bg_search_placeholder:'Buscar fotos...',
    bg_search_btn:        'Buscar',
    // ── Trilhas panel ─────────────────────────────────────────────────────────
    trilhas_title:        'Trilhas — 170 músicas',
    trilhas_royalty:      'Royalty-free',
    trilhas_search:       'Buscar por título ou artista…',
    trilhas_empty:        'Nenhuma trilha encontrada',
    trilhas_use:          '✓ Usar',
    // ── feat2 ─────────────────────────────────────────────────────────────────
    ...
    // ── SupportChat FAQ ───────────────────────────────────────────────────────
    chat_title:           '💬 Central de Ajuda',
    chat_subtitle:        'Selecione um assunto:',
    chat_faq1_q:          'Como exportar o vídeo?',
    chat_faq1_a:          'No editor Pro, selecione o formato (WEBM + Áudio ou HD 1080p) e clique em Salvar. O arquivo será baixado automaticamente.',
    chat_faq2_q:          'Como sincronizar a letra?',
    chat_faq2_a:          'Cole a letra no campo de texto (uma frase por linha), dê Play e clique em ⚡ MARCAR AGORA no ritmo de cada frase.',
    ...
    // ── Feature cards novos ──────────────────────────────────────────────────
    feat7_title:        'Zoom Animado & Keyframes',
    feat7_desc:         'Ken Burns, Punch In, Zoom Out e mais — com 6 tipos de easing e âncora de posição. Cinema no browser.',
    feat8_title:        '52 Stickers Animados',
    feat8_desc:         'Bounce, pulse, spin, shake, float — 52 stickers animados incluindo emojis e setas direcionais interativas.',
    feat9_title:        '22 Fundos Gerados',
    feat9_desc:         'Matrix, Aurora, Galáxia, Lava, Glitch, Nebulosa e mais — fundos cinematográficos gerados no canvas sem imagem.',
    // ── Pro plan novos ────────────────────────────────────────────────────────
    pro_feat9:          '170 trilhas musicais royalty-free',
    pro_feat10:         '68 efeitos sonoros em 8 categorias',
    pro_feat11:         'Molduras cinematográficas (16 estilos)',
    pro_feat12:         'Cor & Curvas + Aberração Cromática',
    // ── Novidades Pro section ─────────────────────────────────────────────────
    new_features_label: 'NOVIDADES',
    new_features_title: 'Recursos que fazem diferença',
    new_features_sub:   'Cada atualização traz mais ferramentas profissionais, sem custo adicional para assinantes Pro.',
    new_feat_trilhas_title: '170 Trilhas Musicais Royalty-Free',
    new_feat_trilhas_desc:  'Biblioteca local com 170 músicas em vários estilos — lo-fi, trap, cinemático, jazz, rock e mais. Prévia e uso direto no projeto.',
    new_feat_sfx_title:     '68 Efeitos Sonoros em 8 Categorias',
    new_feat_sfx_desc:      'Ambiente, Ação, Suspense, Comédia, UI/Tech, Notificação, Dinheiro e Meme. Arquivos reais com cache otimizado.',
    new_feat_zoom_title:    'Zoom Animado com Keyframes',
    new_feat_zoom_desc:     'Ken Burns, Punch In, Zoom Out, Pulse e Fade In — com 6 modos de easing (linear, spring, bounce) e âncora de posição.',
    new_feat_color_title:   'Cor & Curvas Cinematográficas',
    new_feat_color_desc:    'Curvas RGB individuais, midtones, shadows, highlights e aberração cromática global. Estética de filme profissional.',
    ...
    free_feat6:         '170 trilhas musicais royalty-free',
    free_feat7:         '1 vídeo por projeto',
    free_feat8:         'Até 3 frases de letra sincronizadas',
    free_feat9:         '1 texto extra personalizado',
    free_feat10:        'Imagens overlay ilimitadas',
    free_feat11:        'Efeitos de tela básicos',
    free_feat12:        'Templates básicos incluídos',
  ...
  'en': {
    ...
    // ── Screen Effects section (landing) ─────────────────────────────────────
    fx_section_label:   'SCREEN EFFECTS',
    fx_section_title:   '36 Cinematic Effects',
    fx_section_sub:     'From Glitch to Aurora, from Duotone to Matrix — apply with one click directly on the video.',
    fx_section_cta:     '✨ All available in the Pro editor — no installation, runs in the browser',

    sfx_count:            '68 sounds',
    // ── Frames panel ──────────────────────────────────────────────────────────
    frames_btn:           '🖼 Frames',
    frames_title:         '🖼 Frames',
    frames_active_one:    'active',
    frames_active_many:   'active',
    frames_label:         '🖼 Frame',
    frames_remove:        '✕ Remove',
    frames_remove_all:    '✕ Remove all frames',
    frames_color:         'Color',
    frames_color2:        'Color 2',
    frames_thickness:     'Thickness',
    frames_opacity:       'Opacity',
    frames_rotation:      'Rotation',
    frames_corners:       'Corners',
    frames_size:          'Size:',
    frames_fullscreen:    'Fullscreen',
    frames_square:        'Square',
    // ── Animated Zoom / Keyframes ─────────────────────────────────────────────
    kf_zoom_title:        '🎬 Animated Zoom',
    kf_scale:             'Scale',
    kf_opacity:           'Opacity',
    kf_anchor:            'Anchor',
    kf_clear:             'Clear',
    kf_hint_main:         'Pause playback, set the time and click + KF to capture.',
    kf_preset_kenburns:   'Ken Burns',
    kf_preset_punchin:    'Punch In',
    kf_preset_zoomout:    'Zoom Out',
    kf_preset_pulse:      'Pulse',
    ...
    // ── Color & Curves ────────────────────────────────────────────────────────
    cc_btn:               'Color & Curves',
    cc_title:             '🎨 Cinematic Color',
    cc_chroma_global:     '🌈 Global Chromatic Aberration',
    cc_curves:            '📊 Color Curves',
    cc_reset:             '↺ Reset curves',
    // ── Mask and Aberration per element ───────────────────────────────────────
    el_mask:              '✂️ Mask',
    el_mask_feather:      'Feather',
    el_chroma:            '🌈 Chromatic Aberration',
    el_chroma_int:        'Intensity',
    // ── BG Panel tabs ─────────────────────────────────────────────────────────
    bg_tab_gradients:     '🎨 Gradients',
    bg_tab_photos:        '🔍 Photos',
    bg_tab_generate:      '⚡ Generate',
    bg_search_placeholder:'Search photos...',
    bg_search_btn:        'Search',
    // ── Tracks panel ──────────────────────────────────────────────────────────
    trilhas_title:        'Tracks — 170 songs',
    trilhas_royalty:      'Royalty-free',
    trilhas_search:       'Search by title or artist…',
    trilhas_empty:        'No tracks found',
    trilhas_use:          '✓ Use',
    // ── feat2 ─────────────────────────────────────────────────────────────────
    ...
    // ── SupportChat FAQ ───────────────────────────────────────────────────────
    chat_title:           '💬 Help Center',
    chat_subtitle:        'Select a topic:',
    chat_faq1_q:          'How to export the video?',
    chat_faq1_a:          'In the Pro editor, select the format (WEBM + Audio or HD 1080p) and click Save. The file will download automatically.',
    chat_faq2_q:          'How to sync lyrics?',
    chat_faq2_a:          'Paste the lyrics in the text field (one line per phrase), hit Play and click ⚡ MARK NOW on the beat of each phrase.',
    chat_faq3_q:          'How to add videos?',
    chat_faq3_a:          'In the Pro editor there is the 🎬 Videos option at the top. Add videos, adjust position, size, rotation and audio in the timeline.',
    chat_faq4_q:          'Free vs Pro difference?',
    chat_faq4_a:          'Free: static images (PNG/JPG). Pro: video with audio, HD 1080p, lyric sync, videos and no watermark.',
    chat_faq5_q:          'Payment issues',
    chat_faq5_a:          'Payments are processed by Stripe. For issues, contact us at the email below.',

    // ── New feature cards ─────────────────────────────────────────────────────
    feat7_title:        'Animated Zoom & Keyframes',
    feat7_desc:         'Ken Burns, Punch In, Zoom Out and more — with 6 easing types and position anchor. Cinema in the browser.',
    feat8_title:        '52 Animated Stickers',
    feat8_desc:         'Bounce, pulse, spin, shake, float — 52 animated stickers including emojis and interactive directional arrows.',
    feat9_title:        '22 Generated Backgrounds',
    feat9_desc:         'Matrix, Aurora, Galaxy, Lava, Glitch, Nebula and more — cinematic backgrounds generated on canvas with no image needed.',
    // ── New Pro plan items ────────────────────────────────────────────────────
    pro_feat9:          '170 royalty-free music tracks',
    pro_feat10:         '68 sound effects in 8 categories',
    pro_feat11:         'Cinematic frames (16 styles)',
    pro_feat12:         'Color & Curves + Chromatic Aberration',
    // ── New Pro features section ──────────────────────────────────────────────
    new_features_label: 'NEW',
    new_features_title: 'Features that make the difference',
    new_features_sub:   'Every update brings more professional tools — at no extra cost for Pro subscribers.',
    new_feat_trilhas_title: '170 Royalty-Free Music Tracks',
    new_feat_trilhas_desc:  'Local library with 170 songs across multiple styles — lo-fi, trap, cinematic, jazz, rock and more. Preview and use directly in your project.',
    new_feat_sfx_title:     '68 Sound Effects in 8 Categories',
    new_feat_sfx_desc:      'Ambient, Action, Suspense, Comedy, UI/Tech, Notification, Money and Meme. Real audio files with optimized cache.',
    new_feat_zoom_title:    'Animated Zoom with Keyframes',
    new_feat_zoom_desc:     'Ken Burns, Punch In, Zoom Out, Pulse and Fade In — with 6 easing modes (linear, spring, bounce) and position anchor.',
    new_feat_color_title:   'Cinematic Color & Curves',
    new_feat_color_desc:    'Individual RGB curves, midtones, shadows, highlights and global chromatic aberration. Professional film aesthetic.',
    ...
    free_feat6:         '170 royalty-free music tracks',
    free_feat7:         '1 video per project',
    free_feat8:         'Up to 3 synced lyric lines',
    free_feat9:         '1 custom extra text',
    free_feat10:        'Unlimited overlay images',
    free_feat11:        'Basic screen effects',
    free_feat12:        'Basic templates included',
