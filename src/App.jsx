...
function App() {
  ...
  useEffect(() => {
    const PROJECT_FONTS = [
      ...
      { name: "Cocogoose Block Border", file: "Cocogoose Block Border.ttf" },
      { name: "Cocogoose Block Gradient", file: "Cocogoose Block Gradient.ttf" },
      { name: "Cocogoose Block Innerline", file: "Cocogoose Block Innerline.ttf" },
      { name: "Cocogoose Block Shadow", file: "Cocogoose Block Shadow.ttf" },
      { name: "Cocogoose Inline", file: "Cocogoose Inline.ttf" },
      { name: "Cocogoose Letterpress", file: "Cocogoose Letterpress.ttf" },
      { name: "Cocogoose Light", file: "Cocogoose Light.ttf" },
      { name: "Cocogoose Outlined", file: "Cocogoose Outlined.ttf" },
      { name: "Cocogoose Regular", file: "Cocogoose Regular.ttf" },
